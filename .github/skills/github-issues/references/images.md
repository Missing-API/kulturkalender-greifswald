...
- GitHub generates a permanent https://github.com/user-attachments/assets/{UUID} URL
- These URLs work for anyone, even without repo access, and render in email notifications
